	...
	$(document).ready(function() {
		$('#b-documents__add').on('click', function() {
			...
			var inputType=$('<div class="col-xs-3">\n\
								<select class="form-control input-sm" name="Patient_Documents[typeArrMass]['+ i +']">\n\
			...
			var inputSerie=$('<div class="col-xs-3"><input class="form-control input-sm" type="text" name="Patient_Documents[serieArrMass]['+ i +']"></div>');
			var inputNumber=$('<div class="col-xs-3"><input class="form-control input-sm" type="text" name="Patient_Documents[numberArrMass]['+ i +']"></div>');
