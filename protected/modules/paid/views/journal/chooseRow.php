...
<div class="row">
	<div class="col-xs-12" style='text-align: center;'>
		...
		<?= CHtml::button('Печать всех направлений', ['class'=>'btn btn-primary btn-sm', 'id'=>'printReferralsJournal', 'disabled'=>$this->returnReferrals($recordExpense->expense_number) ? false : true]); ?>
